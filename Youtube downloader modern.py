...
def downloader():  # Downloads the youtube video
    if link.get() == "":  # checks if there is a link that is input
        ...
        return
    messagebox.showinfo("Heads up","The program will freeze sometimes, just give it some time")
...
if __name__ == "__main__":
    ...
    Label(app, text="Filetype:", font=("Helvetica", 15)).place(relx=0.38, rely=0.55, anchor=tkinter.CENTER)
